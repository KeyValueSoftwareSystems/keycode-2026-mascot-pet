...
| `v1.10.0` | **Starts small**, and the size, always-on-top and reminder cadences all come from `manifest.json` — changeable for the team without a release. A bad default now costs that default rather than every announcement |
